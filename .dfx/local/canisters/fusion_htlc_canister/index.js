...
import { idlFactory } from './fusion_htlc_canister.did.js';
export { idlFactory } from './fusion_htlc_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FUSION_HTLC_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fusion_htlc_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fusion_htlc_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fusion_htlc_canister.did.js")._SERVICE>}
 */
export const fusion_htlc_canister = createActor(canisterId);
