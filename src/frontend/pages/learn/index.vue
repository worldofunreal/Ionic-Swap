    ...
    <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
          Master the fundamentals of decentralized finance, token standards, and cross-chain swapping. 
      ...
      <!-- Hero Section -->
      <div
        class="rounded-lg p-8 mb-12 text-white"
        :class="`bg-gradient-to-r from-${currentTheme}-600 to-${currentTheme}-800`"
      >
        <div class="max-w-4xl mx-auto text-center">
          <h2 class="text-3xl font-bold mb-4">
            Your Gateway to DeFi Education
          </h2>
          <p class="text-lg opacity-90 mb-6">
            From basic concepts to advanced trading strategies, learn everything you need to know 
            about decentralized finance and cross-chain token swapping.
          </p>
      ...
      <div class="mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <!-- Beginner Path -->
          <div class="bg-white dark:bg-neutral-900 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center gap-3 mb-4">
              <div class="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center">
                <UIcon name="i-heroicons-academic-cap" class="w-6 h-6 text-green-600 dark:text-green-400" />
              </div>
              <div>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Beginner</h3>
                <p class="text-sm text-gray-600 dark:text-gray-400">Start here if you're new to DeFi</p>
              </div>
            </div>
            <p class="text-gray-600 dark:text-gray-400 mb-4">
              Learn the basics of tokens, blockchain standards, and how DeFi works.
            </p>
            <div class="space-y-2">
              <NuxtLink
                to="/learn/what-are-tokens"
                class="block p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
              >
                <div class="flex items-center gap-3">
                  <UIcon name="i-heroicons-currency-dollar" class="w-5 h-5 text-primary-600 dark:text-primary-400" />
                  <span class="text-gray-700 dark:text-gray-300">What are Tokens?</span>
                </div>
              </NuxtLink>
              <NuxtLink
                to="/learn/defi-basics"
                class="block p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
              >
                <div class="flex items-center gap-3">
                  <UIcon name="i-heroicons-banknotes" class="w-5 h-5 text-primary-600 dark:text-primary-400" />
                  <span class="text-gray-700 dark:text-gray-300">DeFi Basics</span>
                </div>
              </NuxtLink>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-neutral-900 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Intermediate</h3>
                <p class="text-sm text-gray-600 dark:text-gray-400">Understand the technical details</p>
              </div>
            </div>
            <p class="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <div class="bg-white dark:bg-neutral-900 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Master cutting-edge features</p>
              </div>
            </div>
            <p class="text-gray-600 dark:text-gray-400 mb-4">
          ...
          >
            <div class="flex items-center gap-3 mb-4">
              ...
              >
                <UIcon 
                  :name="article.icon" 
                  :class="`w-6 h-6 text-${currentTheme}-600 dark:text-${currentTheme}-400`"
                />
              </div>
              <div class="flex-1">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ article.difficulty }}</p>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <UIcon name="i-heroicons-arrow-right" class="w-5 h-5 text-primary-600 dark:text-primary-400 group-hover:translate-x-1 transition-transform" />
            </div>
          </NuxtLink>
        </div>
      </div>
      ...
      <div class="text-center">
        <div class="bg-white dark:bg-neutral-900 rounded-lg shadow-sm p-8 border border-gray-200 dark:border-gray-700">
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">
            Ready to Start Swapping?
          </h2>
          <p class="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
            Now that you understand the basics, try swapping tokens across different blockchain networks 
            with our gasless transaction system.
          </p>
          <NuxtLink
            to="/"
...
useHead({
  title: 'Learn DeFi - Ionic Swap',
  meta: [
    {
      name: 'description',
      content: 'Master the fundamentals of decentralized finance, token standards, and cross-chain swapping. Start your DeFi journey today.',
    },
    { property: 'og:title', content: 'Learn DeFi - Ionic Swap' },
    {
      property: 'og:description',
      content: 'Master the fundamentals of decentralized finance, token standards, and cross-chain swapping. Start your DeFi journey today.',
    },
    { property: 'og:type', content: 'website' },
    { property: 'og:url', content: 'https://ionicswap.com/learn' },
    { property: 'og:image', content: '/logo.svg' },
    { name: 'twitter:card', content: 'summary_large_image' },
    { name: 'twitter:title', content: 'Learn DeFi - Ionic Swap' },
    {
  ...
  link: [{ rel: 'canonical', href: 'https://ionicswap.com/learn' }],
})
</script>
