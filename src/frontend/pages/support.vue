    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        >
          ...
          >
            <UIcon name="i-heroicons-chat-bubble-left-right" class="w-6 h-6 text-green-600 dark:text-green-400" />
          </div>
          <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">
            Live Chat
          </h3>
      ...
      <div class="space-y-8">
        <!-- FAQ Section -->
        <div v-if="activeSection === 'faq'" class="bg-white dark:bg-neutral-800 rounded-lg shadow p-8">
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">
            Frequently Asked Questions
          </h2>
          
          <div class="space-y-6">
            <div v-for="faq in faqs" :key="faq.id" class="border-b border-gray-200 dark:border-gray-700 pb-6">
        ...
        <!-- Chat Section -->
        <div v-if="activeSection === 'chat'" class="bg-white dark:bg-neutral-800 rounded-lg shadow p-8">
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">
            Live Chat Support
          </h2>
          <p class="text-gray-600 dark:text-gray-400 mb-6">
            Our support team is available 24/7 to help you with any questions about cross-chain swapping, 
            gasless transactions, or token trading.
          </p>
        ...
        <!-- Email Section -->
        <div v-if="activeSection === 'email'" class="bg-white dark:bg-neutral-800 rounded-lg shadow p-8">
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">
            Email Support
          </h2>
          <p class="text-gray-600 dark:text-gray-400 mb-6">
...
const faqs = [
  {
    ...
    answer: 'Gasless transactions use cryptographic permits that allow smart contracts to execute transactions on your behalf without requiring you to pay gas fees. You sign a permit with your wallet, and our system submits the transaction to the blockchain.'
  },
  {
    id: 2,
    question: 'Which blockchain networks are supported?',
    answer: 'Ionic Swap supports Ethereum (EVM chains), Solana, and Internet Computer. You can swap tokens between any of these networks seamlessly.'
  },
  {
    id: 3,
    question: 'What token standards are supported?',
    answer: 'We support ERC-20 tokens on EVM chains, SPL tokens on Solana, and ICRC tokens on Internet Computer. This covers the majority of tokens on these networks.'
  },
  {
    id: 4,
    question: 'How long do swaps take?',
    answer: 'Swap times vary by network. Solana swaps are typically fastest (seconds), EVM swaps take 1-5 minutes depending on network congestion, and Internet Computer swaps are usually under 2 minutes.'
  },
  {
    id: 5,
    question: 'Are there any fees for swapping?',
    answer: 'Ionic Swap uses gasless transactions, so you don\'t pay gas fees. However, there may be small network fees or liquidity provider fees depending on the specific swap route.'
  },
  {
    id: 6,
    question: 'Is my wallet secure?',
    answer: 'Yes, Ionic Swap is non-custodial, meaning we never have access to your private keys or funds. All transactions are executed directly from your wallet using secure smart contracts.'
  }
]
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Get help with cross-chain swapping, gasless transactions, and token trading. Find answers to common questions and contact our support team.',
    },
    { property: 'og:title', content: 'Support Center - Ionic Swap' },
    {
      property: 'og:description',
      content: 'Get help with cross-chain swapping, gasless transactions, and token trading.',
    },
