            ...
            <div class="relative z-10 h-full flex flex-col justify-between">
              ...
              <div class="flex items-start justify-between">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ feature.subtitle }}</p>
                  </div>
                </div>
                <div class="text-right">
                  <div class="text-2xl font-bold text-primary-600 dark:text-primary-400">{{ feature.stat }}</div>
                  <div class="text-xs text-gray-500 dark:text-gray-400">{{ feature.statLabel }}</div>
                </div>
              </div>
              ...
              <div class="flex-1 flex items-center justify-center">
                <div class="text-center">
                  <div class="text-4xl font-bold text-gray-900 dark:text-white mb-2">{{ feature.mainValue }}</div>
                  <div class="text-lg text-gray-600 dark:text-gray-400 mb-4">{{ feature.mainLabel }}</div>
                  <div class="flex items-center justify-center gap-4">
                    ...
                    >
                      <div class="w-2 h-2 rounded-full" :class="getChainColor(chain)"></div>
                      <span class="text-xs font-medium text-gray-700 dark:text-gray-300">{{ chain }}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-sm text-green-600 dark:text-green-400 font-medium">{{ feature.change }}</span>
                </div>
                <UButton
