<template>
  <div
    class="flex flex-col gap-6 w-[220px] max-w-[260px] p-4 bg-card rounded-lg border border-themed"
  >
    <!-- Status -->
    <div>
        ...
        <button
          ...
          :class="
            selectedStatus === status
              ...
              : 'bg-surface text-foreground border-themed'
          "
    ...
    <div>
      ...
      <input
        ...
        class="w-full px-3 py-2 rounded border border-themed bg-surface mb-2"
      >
      <div class="flex flex-wrap gap-2">
        <button
