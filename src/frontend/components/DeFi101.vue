    ...
    <div class="relative">
      ...
      >
        <NuxtLink
          ...
          class="min-w-[220px] max-w-xs bg-zinc-100 dark:bg-zinc-900 rounded-xl shadow p-4 flex flex-col gap-2 hover:scale-105 transition-transform cursor-pointer"
        ...
        >
          ...
          <div class="flex items-center gap-3 mb-2">
            ...
            <div class="flex-1">
              ...
              <div class="text-xs text-zinc-500">{{ article.subtitle }}</div>
            </div>
          </div>

          <!-- Article Description -->
          <div
            class="text-sm text-zinc-600 dark:text-zinc-400 mb-3 line-clamp-2"
          >
            {{ article.description }}
          </div>
