...
async function main() {
  console.log('🪙 Creating Ionic Token on Solana');
  console.log('==================================');
  ...
  if (options.programId) {
    ...
    if (fs.existsSync(deploymentPath)) {
      ...
      console.error('❌ No program ID provided and no deployment.json found');
      console.log('💡 Use --program-id <id> or deploy the program first');
      process.exit(1);
    }
  }
